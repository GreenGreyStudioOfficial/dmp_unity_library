...
{
    public class GGAnalyticsExampleControllerSample1 : MonoBehaviour
    {
        ...
        private void CreatePropertyPanel(PropertyInfo typeAttribute, IDeviceInfo deviceInfo)
        {
            ...
            UIPropertyPanelSample1 panelProperties = newPanel.GetComponent<UIPropertyPanelSample1>();
        ...
        {
            List<UIEventPanelSample1> eventPanels = m_eventPanel.transform.parent.GetComponentsInChildren<UIEventPanelSample1>().ToList();

            UIEventPanelSample1 eventPanel = eventPanels.Find(ep => ep.Id == dmpEvent.ID);
            if (eventPanel == null)
                return false;
        ...
        private void CreateEventPanel(GGAnalyticsEvent dmpEvent)
        {
            ...
            UIEventPanelSample1 eventPanel = newPanel.GetComponent<UIEventPanelSample1>();
            eventPanel.UpdateProperties(dmpEvent);
