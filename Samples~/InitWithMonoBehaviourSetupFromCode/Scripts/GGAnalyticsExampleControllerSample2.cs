...
{
    public class GGAnalyticsConfigurationExampleSample2 : IGGAnalyticsConfiguration
    {
    ...
    public class GGAnalyticsExampleControllerSample2 : MonoBehaviour
    {
        ...
        {
            var configuration = new GGAnalyticsConfigurationExampleSample2();
        ...
        private void CreatePropertyPanel(PropertyInfo typeAttribute, IDeviceInfo deviceInfo)
        {
            ...
            UIPropertyPanelSample2 panelProperties = newPanel.GetComponent<UIPropertyPanelSample2>();
        ...
        {
            List<UIEventPanelSample2> eventPanels = m_eventPanel.transform.parent.GetComponentsInChildren<UIEventPanelSample2>().ToList();

            UIEventPanelSample2 eventPanel = eventPanels.Find(ep => ep.Id == dmpEvent.ID);
            if (eventPanel == null)
                return false;
        ...
        private void CreateEventPanel(GGAnalyticsEvent dmpEvent)
        {
            ...
            UIEventPanelSample2 eventPanel = newPanel.GetComponent<UIEventPanelSample2>();
            eventPanel.UpdateProperties(dmpEvent);
